          ...
          {updates.map((update, index) => (
            <div key={index} className="flex flex-col md:flex-row items-center gap-6 bg-white dark:bg-black p-4 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900 dark:text-gray-300">{update.description}</p><br></br>
                <p className="text-sm text-gray-900 dark:text-gray-300">{update.description2}</p><br></br>
                <p className="text-sm text-gray-900 dark:text-gray-300">{update.description3}</p>
              </div>
            </div>
          ))}
        </div>
