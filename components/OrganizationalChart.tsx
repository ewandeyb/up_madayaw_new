  ...
  return (
    <section className="py-8 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 dark:text-black">Organizational Chart</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {officers.map((officer, index) => (
            <div key={index} className="text-center">
              ...
              />
              <h3 className="text-xl font-semibold dark:text-black">{officer.name}</h3>
              ...
              <p className="text-gray-500">
                <a href={officer.googleScholar} target="_blank" rel="noopener noreferrer" className="text-black underline">
